...
class PermissionCategory(BaseModel):
    system = models.ForeignKey(
        'systems.System', on_delete=models.CASCADE, related_name='permission_categories'
    )
...
class Permission(BaseModel):
    system = models.ForeignKey(
        'systems.System', on_delete=models.CASCADE, related_name='permissions'
    )
...
class Role(BaseModel):
    ...
    country = models.ForeignKey(
        'base.Country', null=True, blank=True, on_delete=models.SET_NULL, related_name='roles'
    )
    ...
    def get_all_permission_ids(self, _visited: set = None) -> set:
        ...
        ids = set(
            self.role_permissions.filter(is_active=True).values_list('permission_id', flat=True)
        )
...
class UserPermissionOverride(BaseModel):
    ...
    system_user = models.ForeignKey(
        'accounts.SystemUser', on_delete=models.CASCADE, related_name='permission_overrides'
    )

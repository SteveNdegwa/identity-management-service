...
class PermissionService:
    ...
    def create_role(
        ...
        *,
        ...
        created_by_org: Organization | None = None,
        mfa_required: bool = False,
        mfa_allowed_methods: list | None = None,
    ...
    def update_role(
        ...
        *,
        ...
        mfa_allowed_methods: list | None = None,
        mfa_reauth_window_minutes: int | None = None,
        is_active: bool | None = None,
        permission_codenames: list[str] | None = None,
    ) -> Role:
        if role.is_system_defined:
            raise PermissionServiceError('System-defined roles cannot be modified.')
    ...
    def _sync_role_permissions(
        *,
        ...
        existing = {rp.permission_id: rp for rp in RolePermission.objects.filter(role=role)}
    ...
    @staticmethod
    def _unique_role_slug(
        system: System, country: Country | None, raw_value: str, exclude_id=None
    ) -> str:

...
urlpatterns = [
    path(
        'systems/<str:system_id>/categories/',
        views.category_list_view,
        name='permission-category-list',
    ),
    path(
    ...
    path(
        'systems/<str:system_id>/permissions/', views.permission_list_view, name='permission-list'
    ),
    path(
        'systems/<str:system_id>/permissions/create/',
        views.permission_create_view,
        name='permission-create',
    ),
    path('items/<str:permission_id>/', views.permission_detail_view, name='permission-detail'),
    path(
        'items/<str:permission_id>/update/', views.permission_update_view, name='permission-update'
    ),
    ...
    path(
        ...
        views.override_detail_view,
        name='permission-override-detail',
    ),
    path(
        'overrides/<str:override_id>/revoke/',
        views.override_revoke_view,
        name='permission-override-revoke',
    ),
]

...
class PermissionCategoryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Core', {'fields': ('system', 'name', 'slug', 'description')}),
...
class PermissionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Core', {'fields': ('system', 'category', 'codename', 'name', 'description')}),
        ('Flags', {'fields': ('is_read_only', 'is_sensitive', 'is_active')}),
        ('Audit', {'fields': ('created_at', 'updated_at')}),
    )
...
class RolePermissionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Core', {'fields': ('role', 'permission', 'is_active')}),
        ('Grant Info', {'fields': ('conditions', 'granted_by', 'granted_at')}),
        ('Audit', {'fields': ('created_at', 'updated_at')}),
    )
...
class RoleAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Core', {'fields': ('system', 'country', 'name', 'slug', 'description')}),
        ('Hierarchy', {'fields': ('parent_role',)}),
        ('MFA', {'fields': ('mfa_required', 'mfa_allowed_methods', 'mfa_reauth_window_minutes')}),
        ('Meta', {'fields': ('is_system_defined', 'created_by_org', 'is_active')}),
        ('Audit', {'fields': ('created_at', 'updated_at')}),
    )
...
class UserPermissionOverrideAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Core', {'fields': ('system_user', 'permission', 'effect')}),
        ('Override', {'fields': ('reason', 'expires_at', 'is_active', 'granted_by')}),
        ('Audit', {'fields': ('created_at', 'updated_at')}),
    )

...
class SSOSessionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            'Lifecycle',
            {'fields': ('is_active', 'expires_at', 'last_seen_at', 'revoked_at', 'revoke_reason')},
        ),
...
class PendingContextMFAAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            'MFA',
            {'fields': ('mfa_required_reason', 'mfa_allowed_methods', 'mfa_reauth_window_minutes')},
        ),
        (
            'OAuth',
            {
...
class LoginContextSelectionAdmin(admin.ModelAdmin):
    ...
    search_fields = (
        'sso_session__user__email',
        'system_user__user__email',
        'organization__name',
        'role__name',
    )

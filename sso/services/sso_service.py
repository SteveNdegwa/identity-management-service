...
class SSOService:
    ...
    def authenticate_social(
        ...
        try:
            ...
            raise AuthenticationError('Invalid social account.') from None
    ...
    def verify_magic_link(
        ...
        try:
            ...
            raise AuthenticationError('Invalid or expired magic link.') from None
    ...
    def refresh_tokens(self, raw_refresh_token: str, client: SystemClient) -> TokenResponse:
        ...
        try:
            ...
            raise OAuthError('invalid_grant', 'Refresh token not found.') from None
    ...
    def _consume_mfa_challenge(
        ...
        try:
            ...
            raise AuthenticationError('Invalid or expired MFA code.') from None
    ...
    def _consume_passwordless_challenge(
        ...
        try:
            ...
            raise AuthenticationError('Invalid or expired code.') from None

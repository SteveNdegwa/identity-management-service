...
class SSOSessionSystemAccess(BaseModel):
    session = models.ForeignKey(
        SSOSession, on_delete=models.CASCADE, related_name='system_accesses'
    )
...
class SSOSessionMFAVerification(BaseModel):
    session = models.ForeignKey(
        SSOSession, on_delete=models.CASCADE, related_name='mfa_verifications'
    )
...
class PendingContextMFA(BaseModel):
    session = models.ForeignKey(
        SSOSession, on_delete=models.CASCADE, related_name='pending_context_mfas'
    )
...
class MagicLink(BaseModel):
    user = models.ForeignKey('accounts.User', on_delete=models.CASCADE, related_name='magic_links')
    client = models.ForeignKey('systems.SystemClient', on_delete=models.CASCADE)
...
class LoginContextSelection(BaseModel):
    sso_session = models.ForeignKey(
        SSOSession, on_delete=models.CASCADE, related_name='context_selections'
    )
    system_user = models.ForeignKey('accounts.SystemUser', on_delete=models.CASCADE)

...
class UserAdmin(DjangoUserAdmin):
    ...
    fieldsets = (
        (
            None,
            {'fields': ('email', 'phone_number', 'password', 'pin', 'realm', 'primary_country')},
        ),
        (
            'Profile',
            {
        ...
        (
            'Security',
            {'fields': ('failed_login_attempts', 'locked_until', 'last_login', 'date_joined')},
        ),
    )
    add_fieldsets = (
        (
...
class SystemUserAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Membership', {'fields': ('user', 'system', 'organization', 'country', 'role', 'status')}),
        ('Access', {'fields': ('all_branches', 'branch_access')}),
        (
            'Provisioning',
            {
                'fields': (
        ...
        ('Referrals', {'fields': ('referral_code',)}),
        ('Suspension', {'fields': ('suspended_reason', 'suspended_at', 'suspended_by')}),
        ('Metadata', {'fields': ('external_ref', 'metadata', 'registered_at', 'last_login_at')}),
...
class ContactVerificationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Challenge', {'fields': ('code_hash', 'token_hash', 'expires_at', 'attempts')}),
        (
            'Lifecycle',

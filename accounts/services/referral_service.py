...
class ReferralService:
    @transaction.atomic
    def ensure_referral_code(self, system_user: SystemUser) -> str | None:
    ...
    def attach_referral(self, referred: SystemUser, referral_code: str) -> Referral:
        ...
        try:
            ...
            raise ReferralServiceError('Referral code is invalid.') from None
    ...
    def reward_referrals(
        self,
        referrer: SystemUser,
        referral_ids: Iterable[str] | None = None,
    ) -> list[Referral]:

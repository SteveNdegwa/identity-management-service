...
class OrganizationCountryAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        return (
            ...
            .select_related('organization', 'country', 'approved_by', 'source_onboarding')
        )
...
class BranchAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        return super().get_queryset(request).select_related('organization', 'country', 'parent')
...
class OrganizationOnboardingAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Notes', {'fields': ('applicant_notes', 'internal_notes')}),
        ('Timestamps', {'fields': ('submitted_at', 'reviewed_at', 'completed_at')}),
        ('Audit', {'fields': ('created_at', 'updated_at')}),
    )
...
class OnboardingDocumentAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        return (
            super()
            .get_queryset(request)
            .select_related('onboarding', 'uploaded_by', 'reviewed_by', 'replaces')
        )
...
class OnboardingActivityAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        return (
            super().get_queryset(request).select_related('onboarding', 'performed_by', 'document')
        )
...
class DocumentRequestAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Fulfillment', {'fields': ('fulfilled_by_document', 'fulfilled_at', 'deadline')}),
        ('Audit', {'fields': ('created_at', 'updated_at')}),
    )

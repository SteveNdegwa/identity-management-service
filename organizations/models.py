...
class Organization(BaseModel):
    system = models.ForeignKey(
        'systems.System', on_delete=models.CASCADE, related_name='organizations'
    )
...
class OrganizationCountry(BaseModel):
    ...
    organization = models.ForeignKey(
        Organization, on_delete=models.CASCADE, related_name='organization_countries'
    )
    country = models.ForeignKey(
        'base.Country', on_delete=models.CASCADE, related_name='organization_countries'
    )
...
class Branch(BaseModel):
    ...
    country = models.ForeignKey('base.Country', on_delete=models.PROTECT, related_name='branches')
    name = models.CharField(max_length=255)
...
class OrganizationOnboarding(BaseModel):
    ...
    system = models.ForeignKey(
        'systems.System', on_delete=models.CASCADE, related_name='onboardings'
    )
...
class OnboardingDocument(BaseModel):
    onboarding = models.ForeignKey(
        OrganizationOnboarding, on_delete=models.CASCADE, related_name='documents'
    )
    ...
    uploaded_by = models.ForeignKey(
        'accounts.SystemUser', on_delete=models.PROTECT, related_name='uploaded_documents'
    )
...
class OnboardingActivity(BaseModel):
    onboarding = models.ForeignKey(
        OrganizationOnboarding, on_delete=models.CASCADE, related_name='activities'
    )
    activity_type = models.CharField(
        max_length=40, choices=OnboardingActivityType.choices, db_index=True
    )
...
class DocumentRequest(BaseModel):
    onboarding = models.ForeignKey(
        OrganizationOnboarding, on_delete=models.CASCADE, related_name='document_requests'
    )
    document_type = models.CharField(max_length=40, choices=DocumentType.choices)
    label = models.CharField(max_length=120, blank=True)
    ...
    def is_overdue(self):
        return (
            self.deadline is not None and not self.is_fulfilled and timezone.now() > self.deadline
        )

...
class OrganizationService:
    ...
    def update_branch(
        ...
        if parent is not None:
            ...
            if self._is_descendant(branch, parent):
                raise OrganizationServiceError(
                    'Cannot set a descendant as the parent (circular reference).'
                )
    ...
    @staticmethod
    def _unique_slug(system: System, name: str, exclude_id: str | None = None) -> str:
    ...
    def _audit(
        ...
        AuditLog.objects.create(
            ...
            actor_user_id=actor_system_user.user.id
            if actor_system_user and actor_system_user.user
            else None,
            actor_email=actor_system_user.user.get_email()
            if actor_system_user and actor_system_user.user
            else '',

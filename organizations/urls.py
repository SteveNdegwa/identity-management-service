...
urlpatterns = [
    ...
    path(
        'onboarding/services/', views.onboarding_service_list_view, name='onboarding-service-list'
    ),
    # ======================
    ...
    path(
        'onboarding/<str:onboarding_id>/update/',
        views.onboarding_update_view,
        name='onboarding-update',
    ),
    path(
        'onboarding/<str:onboarding_id>/approve/',
        views.onboarding_approve_view,
        name='onboarding-approve',
    ),
    path(
        'onboarding/<str:onboarding_id>/reject/',
        views.onboarding_reject_view,
        name='onboarding-reject',
    ),
    path(
        'onboarding/<str:onboarding_id>/complete/',
        views.onboarding_complete_view,
        name='onboarding-complete',
    ),
    path(
        'onboarding/<str:onboarding_id>/note/',
        views.onboarding_add_note_view,
        name='onboarding-add-note',
    ),
    path(
        'onboarding/<str:onboarding_id>/services/select/',
        views.onboarding_select_services_view,
        name='onboarding-select-services',
    ),
    path(
        'onboarding/<str:onboarding_id>/payments/record/',
        views.onboarding_record_payment_view,
        name='onboarding-record-payment',
    ),
    path(
        'onboarding/<str:onboarding_id>/verifications/trigger/',
        views.onboarding_trigger_verifications_view,
        name='onboarding-trigger-verifications',
    ),
    path(
        'onboarding/verifications/<str:run_id>/update/',
        views.onboarding_update_verification_run_view,
        name='onboarding-update-verification-run',
    ),
    # Onboarding Countries
    path(
        'onboarding/<str:onboarding_id>/countries/add/',
        views.onboarding_country_add_view,
        name='onboarding-country-add',
    ),
    path(
        'onboarding/countries/<str:country_request_id>/update/',
        views.onboarding_country_update_view,
        name='onboarding-country-update',
    ),
    path(
        'onboarding/countries/<str:country_request_id>/remove/',
        views.onboarding_country_remove_view,
        name='onboarding-country-remove',
    ),
    ...
    path(
        '<str:organization_id>/update/', views.organization_update_view, name='organization-update'
    ),
    path(
        '<str:organization_id>/deactivate/',
        views.organization_deactivate_view,
        name='organization-deactivate',
    ),
    path(
        '<str:organization_id>/reactivate/',
        views.organization_reactivate_view,
    ...
    path(
        'branches/<str:branch_id>/deactivate/',
        views.branch_deactivate_view,
        name='branch-deactivate',
    ),
    path(
        'branches/<str:branch_id>/reactivate/',
        views.branch_reactivate_view,
        name='branch-reactivate',
    ),
    # Settings
    ...
    path(
        'countries/<str:org_country_id>/update/',
        views.org_country_update_view,
        name='org-country-update',
    ),
    path(

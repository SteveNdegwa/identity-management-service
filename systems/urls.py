...
urlpatterns = [
    ...
    path(
        '<str:system_id>/countries/add/', views.system_country_add_view, name='system-country-add'
    ),
    path(
        '<str:system_id>/countries/remove/',
        views.system_country_remove_view,
        name='system-country-remove',
    ),
    ...
    path(
        'clients/<str:client_id>/regenerate-secret/',
        views.client_regenerate_secret_view,
        name='system-client-regenerate-secret',
    ),
    path(
        'clients/<str:client_id>/deactivate/',
        views.client_deactivate_view,
        name='system-client-deactivate',
    ),
    path(
        'clients/<str:client_id>/reactivate/',
        views.client_reactivate_view,
        name='system-client-reactivate',
    ),

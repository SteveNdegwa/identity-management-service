...
def _system_payload(system: System) -> dict:
    return {
        ...
        "required_identifier_types": system.required_identifier_types,
        "allowed_login_identifier_types": system.allowed_login_identifier_types,
...
def _client_payload(client: SystemClient) -> dict:
    return {
        ...
        "override_allowed_login_identifier_types": client.override_allowed_login_identifier_types,
...
def system_create_view(request: ExtendedRequest) -> JsonResponse:
    try:
        ...
        system = system_service.create_system(
            ...
            required_identifier_types=data.get("required_identifier_types", []),
            allowed_login_identifier_types=data.get("allowed_login_identifier_types", []),
...
def client_create_view(request: ExtendedRequest, system_id: str) -> JsonResponse:
    ...
    try:
        ...
        client, raw_secret = system_service.create_client(
            ...
            override_allowed_login_identifier_types=data.get("override_allowed_login_identifier_types"),
